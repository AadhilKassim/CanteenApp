...
public class WhiteCanteenMenu extends JFrame {
    ...
    public WhiteCanteenMenu() {
        ...
        Color headerBg = new Color(45, 45, 45);  // dark gray
    ...
    public static void main(String[] args) {
        ...
        SwingUtilities.invokeLater(() -> {
            WhiteCanteenMenu app = new WhiteCanteenMenu();
            app.setVisible(true);
        });
    }
}
